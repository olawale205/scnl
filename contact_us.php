    ...
    <td><table width="940" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="75" align="left" background="images/index_r1.jpg"><a href="career.php">
          <div align="center" class="menu">Careers</div>
        </a></td>
        <td width="10" align="left"><img src="images/index_r2_c8.jpg" alt="" width="10" height="27" /></td>
        <td width="85" align="left" background="images/index_r1.jpg">
        <div align="center" class="menu">Contact us</div></td>
        <td width="10" align="left"><img src="images/index_r2_c8.jpg" alt="" width="10" height="27" /></td>
    ...
    <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="content">
      <tr>
        <td align="left" valign="top" class="h4_font"><table width="95%" border="0" align="center">
          <tr>
            <td><div class="container" id="contact" name="contact">
			<div class="row">
			  <h1 class="centered">THANKS FOR VISITING US</h1>
				...
				<div class="col-lg-6">
				  <h3>Contact Information</h3>
					<p>
                        <span class="icon icon-home"></span>Registered Addr. No. 25, Behind TADP, Jalingo,Taraba State, Nigeria<br/>
                        <span class="icon icon-home"></span>Office Addr. No 7/8, Miyapet Plaza, Jalingo,Taraba State, Nigeria<br/>
						<span class="icon icon-phone"></span> +234 (0) 7037759600 <br/>
						<span class="icon icon-mobile"></span>+234 (0) 8058196510<br />
+234 (0) 8138837349<br />
+234 (0) 8065915331 <br/>
				...
				<div class="col-lg-6">
					<h3>Contact Us</h3>
					<p>Drop us a message below.</p>
					<p>
						<form class="form-horizontal" role="form">
						  <div class="form-group">
						    <label for="txtemail" class="col-lg-4 control-label"></label>
						    <div class="col-lg-10">
						      <input type="email" class="form-control" id="txtemail" placeholder="Email">
						    </div>
						  </div>
						  <div class="form-group">
						    <label for="txtname" class="col-lg-4 control-label"></label>
						    <div class="col-lg-10">
						      <input type="text" class="form-control" id="txtname" placeholder="Your Name">
						    </div>
						  </div>
                    <div class="form-group">
                        <label for="txtmessage" class="col-lg-4 control-label"></label>
                        <div class="col-lg-10">
                            <textarea type="text" class="form-control" id="txtmessage" placeholder="Your Message"></textarea>
                        </div>
                    </div>
						  <div class="form-group">
						    <div class="col-lg-10">
